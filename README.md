...
# Code for: Memory, chaos, and noise in ecological forecasting

<!-- badges: start -->
<!-- badges: end -->

This repository contains the code and data associated with the paper "Memory,
chaos, and noise in ecological forecasting" by Stephan Munch and Tanya Rogers
(2026) published in PNAS.
...
For data citations, see the Data Availability section of the paper, 
SI Appendix section 4, and the metadata files in this repository.
