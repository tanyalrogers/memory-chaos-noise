...
classic=theme_classic() + theme(panel.border = element_rect(color="black", fill="transparent"), axis.text = element_text(color="black"), axis.ticks = element_line(color="black"))
